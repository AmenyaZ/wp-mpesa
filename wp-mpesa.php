<?php
/*
Plugin Name: Mpesa Daraja for WooCommerce
Plugin URI: https://developer.safaricom.co.ke/
Description: Receive payments directly to your store through the Safaricom M-Pesa.
Version: 1.0
WC requires at least: 4.0.0
WC tested up to: 5.2.1
Author: Amenya <zamenya98@gmail.com>
Author URI: http://amenya.com

    Copyright: © 2021 Amenya <zamenya98@gmail.com>.
    License: GNU General Public License v2
    License URI: http://www.gnu.org/licenses/gpl-2.0.html
*/

$wc_mpesa_db_version = "1.2.3";
...
function wc_mpesa_init()
{
    ...
    class WC_Gateway_MPESA extends WC_Payment_Gateway
    {
        ...
        {
            //validate currency
            // if ('KSh' != get_woocommerce_currency()) {
